...
from pba.sorting.shell_sort import ShellSort
...
class TestShellSort(unittest.TestCase):
    ...
    def test_shell_sort_with_id(self):
        ...
        sorter = ShellSort(self.patient_records, key='id')
        sorter.sort()
    ...
    def test_shell_sort_with_age(self):
        self.assertEqual(self.patient_records.head.data, self.patient2)
        self.assertEqual(self.patient_records.tail.data, self.patient1)
        sorter = ShellSort(self.patient_records, key='age')
        sorter.sort()
